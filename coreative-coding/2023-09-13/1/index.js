...
function draw() {
	...
	const applyCamera = () => {
		// rotateX(map(mouseY, 0, height, -1, 1, true) * PI * 0.1)
		// rotateY(map(mouseX, 0, width, -1, 1, true) * PI * 0.1)
		
		// translate(
		// 	80 * map(noise(t * 0.0002, 0), 0, 1, -1, 1),
		// 	80 * map(noise(t * 0.0002, 1000), 0, 1, -1, 1),
		// 	80 * map(noise(t * 0.0002, 2000), 0, 1, -1, 1),
		// )
